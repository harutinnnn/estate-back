...
use App\Models\CommunicationsMLModel;
use App\Models\CommunicationsModel;

class Communications extends AdminMainController
{

    public string $mod = 'communications';
    ...
    public function edit($id = 0, $pageNum = 0)
    {
        ...
        $model = new CommunicationsModel();
        $modelML = new CommunicationsMLModel();
    ...
    public function delete($id = 0): \CodeIgniter\HTTP\RedirectResponse
    {
        ...
        if (intval($id)) {
            ...
            DbUtils::deleteMl(new CommunicationsModel(), new CommunicationsMLModel(), intval($id));
