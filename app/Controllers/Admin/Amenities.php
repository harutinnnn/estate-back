...
use App\Models\AmenitiesMLModel;
use App\Models\AmenitiesModel;

class Amenities extends AdminMainController
{

    public string $mod = 'amenities';
    ...
    public function index(): string
    {
        ...
        $pager = $this->paginationMl($model, ['t.id', 't.status', 't.pos', 'tML.title','t.type'], $where, ADMIN_DEF_LANG, ['col' => 'pos', 'sort' => 'ASC']);
    ...
    public function delete($id = 0): \CodeIgniter\HTTP\RedirectResponse
    {
        ...
        if (intval($id)) {
            ...
            DbUtils::deleteMl(new AmenitiesModel(), new AmenitiesMLModel(), intval($id));
