...
use App\Models\StatesMLModel;
use App\Models\StatesModel;

class States extends AdminMainController
{

    public string $mod = 'states';
    ...
    public function delete($id = 0): \CodeIgniter\HTTP\RedirectResponse
    {
        ...
        if (intval($id)) {
            ...
            DbUtils::deleteMl(new StatesModel(), new StatesMLModel(), intval($id));
