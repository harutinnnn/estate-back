...
use App\Models\HouseholdAppliancesMLModel;
use App\Models\HouseholdAppliancesModel;

class Household_appliances extends AdminMainController
{

    public string $mod = 'household_appliances';
    ...
    public function index(): string
    {
        ...
        $model = new HouseholdAppliancesModel();
    ...
    public function edit($id = 0, $pageNum = 0)
    {
        ...
        $model = new HouseholdAppliancesModel();
        $modelML = new HouseholdAppliancesMLModel();
    ...
    public function delete($id = 0): \CodeIgniter\HTTP\RedirectResponse
    {
        ...
        if (intval($id)) {
            ...
            DbUtils::deleteMl(new HouseholdAppliancesModel(), new HouseholdAppliancesMLModel(), intval($id));
