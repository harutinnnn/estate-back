...
class Categories extends AdminMainController
{

    public string $mod = 'categories';
    ...
    public function delete($id = 0): \CodeIgniter\HTTP\RedirectResponse
    {
        ...
        if (intval($id)) {
            ...
            DbUtils::deleteMl(new CategoryModel(), new CategoryMLModel(), intval($id));
