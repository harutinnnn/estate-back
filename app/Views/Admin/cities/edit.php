                        ...
                        <form method="post" enctype="multipart/form-data" onsubmit="return checkNotFinishedCrops()">
                            <div class="card-body ">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="state"><?= translate('state') ?> <code>*</code></label>
                                        <?php
                                        ...
                                        echo form_dropdown($inputData, $states ?? [], (isset($item->state) ? $item->state : (request()->getGet('state') ? request()->getGet('state') : set_value('status'))));
                                        ?>
                                        <div class="error-msg mb-3">
