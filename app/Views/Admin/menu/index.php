                                ...
                                <?php if (isset($items) && !empty($items)): ?>
                                    <?php foreach ($items as $item): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="/<?= ADMIN_LINK ?>/<?= $mod ?>/section/<?= $item->id ?>"><?= $item->title ?></a>
                                            </td>
                                            ...
                                            <td class="text-right quick-actions">
                                                ...
                                                <a href="/<?= ADMIN_LINK ?>/<?= $mod ?>/section/<?= $item->id ?>">
                                                ...
                                                <?php if (!isset($item->haveNodes) || (isset($item->haveNodes) && !$item->haveNodes)): ?>
