                            ...
                            <div class="card-body ">
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        <label for="type"><?= translate('type') ?> <code>*</code></label>
                                        <?php
                                        ...
                                        echo form_dropdown($inputData, [
                                            AmenitiesModel::TYPE_MAIN => AmenitiesModel::TYPE_MAIN,
                                            AmenitiesModel::TYPE_KITCHEN => AmenitiesModel::TYPE_KITCHEN,
                                            AmenitiesModel::TYPE_BEDROOM => AmenitiesModel::TYPE_BEDROOM,
                                            AmenitiesModel::TYPE_OUTDOOR => AmenitiesModel::TYPE_OUTDOOR,
                                            AmenitiesModel::TYPE_ADDITIONAL => AmenitiesModel::TYPE_ADDITIONAL
                                        ], (isset($item->type) ? $item->type : set_value('type')));
                                        ?>
