            ...
            <div class="col-12 col-lg-8">
                <div class="blog-posts-area">
                    ...
                    <div class="single-blog-post featured-post single-post">
                        <?php if (is_file(FCPATH . DIRECTORY_SEPARATOR . 'uploads' . DIRECTORY_SEPARATOR . 'posts' . DIRECTORY_SEPARATOR . $item->img)): ?>
                            <div class="post-thumb">
                                <a href="#"><img src="/uploads/posts/<?= $item->img ?>" alt=""></a>
                            </div>
                            ...
                            <form action="#" method="post">
                                <div class="row">
                                    ...
                                    <div class="col-12 text-center">
                                        <button class="btn newspaper-btn mt-30 w-100" type="submit">Submit Comment
                                        </button>
                                    </div>
                                </div>
                            </form>
